  ...
  <div class="top-0 z-50 w-full flex items-center h-[66px] bg-[#fff] dark:bg-[#000] justify-between px-2 md:px-7.5 py-3 fixed">
    ...
    <div class="flex items-center gap-4 relative">
      <div class="mr-4">
        ...
        <svg v-if="mode === 'dark'" @click="mode = 'light', toggleStore.darkModeState = 'lightMode'"
          class="cursor-pointer h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" width="15" height="15"
          viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
